...
# SSH - add my private key to ssh-agent
ssh-add -q -D # deletes all keys from the ssh-agent
[[ -s "$HOME/.ssh/mgoedecke" ]] && ssh-add -q "$HOME/.ssh/mgoedecke" # adds my key to ssh-agent
